...
public class EnemyCollision implements PlayerSubscriber, EnemySubscriber {
    ...
    private final ArrayList<Integer> tileWallIds = new ArrayList<>(Arrays.asList(0, 1, 2, 3,
            25, 26, 27, 28, 50, 51, 52, 53, 75, 76, 77, 78, 100, 101, 102, 103, 104, 125, 126, 127,
            128, 129, 130, 150, 151, 152, 153, 154, 350, 351, 352, 353, 354, 355, 356, 357, 358,
            359, 375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 400, 401, 402, 403, 404, 405,
            406, 407, 408, 451, 454, 457, 486, 185, 186, 210, 211));
    ...
    private void checkCollisionWithWall(double posX, double posY) {
        ...
        checkDown(posX, posY);
        checkUp(posX, posY);
        Log.d("values", String.format("right: %b, up: %b, down: %b, left: %b", right, up,
                bottom, left));
    }
